...
import wishListSlice from "../utilis/store/wishListSlice"
        ...
        <div className="w-full h-full flex justify-center">
            ...
            <div className="w-[80%] font-[Roboto]">
                ...
                <div className="w-full mt-5 min-h-[250px] border-[#707070] border">
                    ...
                    {WishListItems.length?WishListItems.map((book:any,index:number)=><WishListCardComponent key={index} 
                    book={book}/>) 
                    :
                    <div className="flex h-[180px] justify-center items-center gap-2"><HeartBroken/><h1 className="text-xl">Your Wishlist is Empty!</h1>
                    </div>
                    }
                    </div>
                </div>
